...
export const SITE = {
  ...
  shortDescription:
    "New York City's #1 live desi comedy dating show. Real singles. Real dates. 250-person audience. Weekly in Manhattan.",
  footerLine: "America's #1 live desi dating show. Hosted by Surbhi & Wyatt.",
  hosts: "Surbhi & Wyatt",
