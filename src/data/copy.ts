...
export const SITE = {
  ...
  footerLine: "NYC's #1 live South Asian dating show. Hosted by Surbhi & Wyatt.",
  hosts: "Surbhi & Wyatt",
} as const;
...
export const HOME_FAQS: FaqItem[] = [
  {
    ...
    short:
      "Garam Masala Dating is NYC's #1 live South Asian dating show. A 90-minute live event where two real singles go on a first date on stage in front of a live audience, hosted by comedians Surbhi and Wyatt.",
...
export const EXPERIENCE_STEPS = [
  {
    ...
    text: "Doors open 30 minutes early. Grab a drink, find your seat, and settle into the energy. The venue is intimate \u2014 250 seats, no bad views.",
  },
  {
