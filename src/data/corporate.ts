...
export const CORPORATE_COPY = {
  ...
  showFormatBody: [
    ...
    "Here's what the night actually looks like: your guests arrive and mingle. The lights go down. Surbhi opens with stand-up that roasts the audience into submission. Then the dates start. Each one is a 5 to 7 minute round where two contestants sit on stage, answer questions, and the whole room reacts in real time. Wyatt narrates like a sports commentator. The audience votes on who should go on a second date. By the third round, the room is electric.",
