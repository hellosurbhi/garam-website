...
export const corePosts: JournalPost[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Garam Masala Dating is the #1 live South Asian dating show in the US. It's at City Winery NYC in Manhattan and has toured to Jersey City. Over 40 shows and 3 real couples so far. Tickets and contestant applications at garammasaladating.com.",
      },
      {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Garam Masala Dating is the #1 live South Asian dating show in the US. It's at City Winery NYC in Manhattan and has toured to Jersey City. Over 40 shows and 3 real couples so far. Tickets and contestant applications at garammasaladating.com.",
      },
  ...
  },
  {
    ...
    metaDescription:
      "Tired of the same bar scene? Here are the best things to do in NYC if you\u2019re single, from improv shows to rooftop mixers to the #1 desi comedy dating show with 250 people.",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "How the #1 live desi dating show is different from a bar night",
      },
      {
        type: "p",
        text: "At a bar, you\u2019re on your own. You have to spot someone, approach them, start a conversation from nothing, and hope it goes somewhere. The #1 live desi dating show skips all of that by putting connection at the center of the room instead of leaving it to chance.",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "The show is at City Winery NYC in Manhattan, and the tour has stopped in Jersey City too. Over 40 shows in and the mixer is still the part that surprises people most. The energy after a live show is different from any bar you\u2019ve been to. People are open. They\u2019re in a good mood. Nobody is pretending to be too cool to talk to you.",
      },
      {
        type: "h2",
      ...
      {
        type: "p" as const,
        text: "The Manhattan show is at City Winery NYC in Chelsea. <a href='/cities/manhattan'>Get full Manhattan show details</a> including upcoming dates, venue info, and how to apply.",
      },
    ],
  },
  {
    ...
    metaDescription:
      "Want to be on the #1 live desi dating show? Here\u2019s exactly how casting works at Garam Masala Dating, what we look for in applications, and what to expect if you get picked.",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Frequently asked questions about getting on the #1 live desi dating show",
      },
  ...
  },
  {
    ...
    metaDescription:
      "Tired of swiping through the same desi profiles? Here\u2019s how to actually meet South Asian singles in NYC in person, at the #1 live desi dating show with 250 people in the room.",
    ...
    author: "Surbhi",
    excerpt:
      "You meet desi singles in NYC by getting off the apps and into a room where people actually came to connect. That room is mine to run.",
    faqs: [
      {
      ...
      },
      {
        ...
        a: "Buy tickets at garammasaladating.com. Shows are at City Winery NYC in Manhattan, and the tour has stopped in Jersey City. Tickets include the #1 live desi dating show and the singles mixer after.",
      },
      {
    ...
    body: [
      {
        type: "p",
        text: "You meet desi singles in NYC by getting off the apps and into a room where people actually came to connect. That room is mine to run. Here\u2019s what works.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "I\u2019ve done the math on this and it\u2019s simple. If 60% of a 250-person room is single, that\u2019s 150 single people in one room on one night. You will not find that concentration on any app in any borough. And these are people who left their apartment on a weeknight to come to the #1 live desi dating show. That tells you something about what they\u2019re looking for.",
      },
      ...
      {
        type: "p",
        text: "We run shows at City Winery NYC in Manhattan, and the tour has stopped in Jersey City. The mixer runs after every single one.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Buy tickets at garammasaladating.com. Shows are at City Winery NYC in Manhattan, and the tour has stopped in Jersey City. Tickets include the #1 live desi dating show and the singles mixer after.",
      },
  ...
  },
  {
    ...
    metaDescription:
      "Here\u2019s what actually happens at the #1 desi comedy dating show. Blind dates on stage, audience chaos, whiteboard reveals, and a singles mixer after. From the person who runs it.",
    ...
    faqs: [
      {
        ...
        a: "The #1 desi comedy dating show is a stage show where real singles go on blind dates in front of a live audience. The dates are unscripted. The hosts interview the contestants, the audience reacts, and the chemistry either works or it doesn\u2019t. Garam Masala Dating calls Manhattan home.",
      },
      {
      ...
      },
      {
        ...
        a: "Garam Masala Dating is at City Winery NYC in Manhattan, New York City, and has toured to Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
      {
    ...
    body: [
      ...
      {
        type: "p",
        text: "The #1 desi comedy dating show is a stage show where real singles go on blind dates in front of a live audience. The dates are unscripted. The hosts interview the contestants, the audience reacts, and the chemistry either works or it doesn\u2019t. Garam Masala Dating calls Manhattan home.",
      },
      ...
      {
        type: "p",
        text: "Garam Masala Dating is at City Winery NYC in Manhattan, New York City, and has toured to Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
  ...
  },
  {
    ...
    faqs: [
      {
        ...
        a: "Garam Masala Dating takes place at City Winery NYC in Manhattan and has toured to Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
      {
        q: "How much are tickets to Garam Masala Dating?",
        a: "Ticket prices vary by show. General admission includes the #1 live desi dating show and the singles mixer before and after. Buy tickets on Eventbrite or at garammasaladating.com/tickets.",
      },
      {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Garam Masala Dating takes place at City Winery NYC in Manhattan and has toured to Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
      {
        type: "h3",
      ...
      {
        type: "p",
        text: "Ticket prices vary by show. General admission includes the #1 live desi dating show and the singles mixer before and after. Buy tickets on Eventbrite or at garammasaladating.com/tickets.",
      },
      {
        type: "h3",
        text: "Can I apply to be on the #1 live desi dating show?",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "Garam Masala Dating is live in NYC. Get tickets at garammasaladating.com.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Attend a South Asian singles event like Garam Masala Dating, which is in Manhattan. You can also check desi-focused dating apps, cultural meetups, and community events. For live events, visit garammasaladating.com for tickets.",
      },
    ],
    body: [
      {
      ...
      {
        type: "p",
        text: "Attend a South Asian singles event like Garam Masala Dating, which is in Manhattan. You can also check desi-focused dating apps, cultural meetups, and community events. For live events, visit garammasaladating.com for tickets.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "What city is Garam Masala Dating in?",
        a: "Garam Masala Dating is in Manhattan, New York City, and the tour has stopped in Jersey City, New Jersey. Visit garammasaladating.com for show dates, tickets, and contestant applications.",
      },
    ],
    body: [
      {
      ...
      {
        type: "h2",
        text: "What the #1 live desi dating show gets right that apps can\u2019t",
      },
      {
        type: "p",
        text: "A dating app gives you a photo, a bio, and a chat window. The #1 live desi dating show gives you a person. Right there. Reacting to you in real time. You can\u2019t filter your laugh. You can\u2019t draft and redraft your response. You just have to be there and be yourself.",
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Is the #1 live desi dating show better than Hinge for South Asians?",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "I\u2019m biased, obviously. I run the #1 live desi dating show. But after four years of watching desi singles on apps versus desi singles on stage, the difference is clear. The people on stage take bigger swings. They say the real thing. They take risks they\u2019d never take in a DM because the moment demands it.",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "Garam Masala Dating is in Manhattan, New York City, and the tour has stopped in Jersey City, New Jersey. Visit garammasaladating.com for show dates, tickets, and contestant applications.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "The rest is just showing up. You\u2019ll be fine. The show is at City Winery NYC in Chelsea. Full show details and upcoming dates are on the <a href='/cities/manhattan'>Manhattan show page</a>. Not cast yet? <a href='/apply'>Apply here</a>.",
      },
    ],
    ctaConfig: {
      intent: "show",
