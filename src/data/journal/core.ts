...
export const corePosts: JournalPost[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Garam Masala Dating is the #1 live South Asian dating show in the US. It runs regularly at City Winery NYC in Manhattan and has also toured to Jersey City. Over 40 shows and 3 real couples so far. Tickets and contestant applications at garammasaladating.com.",
      },
      {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Garam Masala Dating is the #1 live South Asian dating show in the US. It runs regularly at City Winery NYC in Manhattan and has also toured to Jersey City. Over 40 shows and 3 real couples so far. Tickets and contestant applications at garammasaladating.com.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p" as const,
        text: "The Manhattan show runs regularly at City Winery NYC in Chelsea. <a href='/cities/manhattan'>Get full Manhattan show details</a> including upcoming dates, venue info, and how to apply.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Buy tickets at garammasaladating.com. Shows run regularly at City Winery NYC in Manhattan, with the tour also stopping in Jersey City. Tickets include the #1 live desi dating show and the singles mixer after.",
      },
      {
    ...
    body: [
      ...
      {
        type: "p",
        text: "We run shows regularly at City Winery NYC in Manhattan, and the tour has also stopped in Jersey City. The mixer runs after every single one.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Buy tickets at garammasaladating.com. Shows run regularly at City Winery NYC in Manhattan, with the tour also stopping in Jersey City. Tickets include the #1 live desi dating show and the singles mixer after.",
      },
  ...
  },
  {
    ...
    faqs: [
      {
        ...
        a: "The #1 desi comedy dating show is a stage show where real singles go on blind dates in front of a live audience. The dates are unscripted. The hosts interview the contestants, the audience reacts, and the chemistry either works or it doesn\u2019t. Garam Masala Dating runs regularly in Manhattan.",
      },
      {
      ...
      },
      {
        ...
        a: "Garam Masala Dating runs regularly at City Winery NYC in Manhattan, New York City. The show has also run in Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
      {
    ...
    body: [
      ...
      {
        type: "p",
        text: "The #1 desi comedy dating show is a stage show where real singles go on blind dates in front of a live audience. The dates are unscripted. The hosts interview the contestants, the audience reacts, and the chemistry either works or it doesn\u2019t. Garam Masala Dating runs regularly in Manhattan.",
      },
      ...
      {
        type: "p",
        text: "Garam Masala Dating runs regularly at City Winery NYC in Manhattan, New York City. The show has also run in Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
  ...
  },
  {
    ...
    faqs: [
      {
        ...
        a: "Garam Masala Dating takes place at City Winery NYC in Manhattan. The show has also run in Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
      {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Garam Masala Dating takes place at City Winery NYC in Manhattan. The show has also run in Jersey City, New Jersey. Visit garammasaladating.com for the full schedule and tickets.",
      },
      {
        type: "h3",
      ...
      {
        type: "p",
        text: "Garam Masala Dating runs regularly in NYC. Get tickets at garammasaladating.com.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Attend a South Asian singles event like Garam Masala Dating, which runs regularly in Manhattan. You can also check desi-focused dating apps, cultural meetups, and community events. For live events, visit garammasaladating.com for tickets.",
      },
    ],
    body: [
      {
      ...
      {
        type: "p",
        text: "Attend a South Asian singles event like Garam Masala Dating, which runs regularly in Manhattan. You can also check desi-focused dating apps, cultural meetups, and community events. For live events, visit garammasaladating.com for tickets.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "What city is Garam Masala Dating in?",
        a: "Garam Masala Dating runs regularly in Manhattan, New York City, and the tour has also stopped in Jersey City, New Jersey. Visit garammasaladating.com for show dates, tickets, and contestant applications.",
      },
    ],
    body: [
      {
      ...
      {
        type: "p",
        text: "Garam Masala Dating runs regularly in Manhattan, New York City, and the tour has also stopped in Jersey City, New Jersey. Visit garammasaladating.com for show dates, tickets, and contestant applications.",
      },
      {
        type: "p",
