...
export const eventsPosts: JournalPost[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. Garam Masala Dating is the #1 desi comedy dating show in NYC designed for South Asian singles. It runs at City Winery NYC in Manhattan and monthly in Jersey City. After the show there's a singles mixer. Tickets and applications at garammasaladating.com.",
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p" as const,
        text: "The show runs in Manhattan and monthly in Jersey City. <a href='/cities/manhattan'>See the Manhattan show page</a> for upcoming dates, venue details, and the contestant application.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Tickets to Garam Masala Dating are available at garammasaladating.com. The show runs at City Winery NYC in Manhattan and monthly in Jersey City. General admission includes the full live show and the singles mixer after.",
      },
      {
