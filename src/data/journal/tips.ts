...
export const tipsPosts: JournalPost[] = [
  {
    ...
    body: [
      {
        type: "p",
        text: "Finding love as a South Asian in NYC means getting off the apps and tapping into high-intent, real-world networks. Stop wasting time on endless swiping with people who just want casual flings. Be unapologetically upfront about wanting a serious relationship, leverage curated community events, and date with strict intention to find your person.",
      },
      {
        type: "h3",
      ...
      {
        type: "p",
        text: "Here is how you actually cut through the noise:",
      },
      {
        type: "h3",
      ...
      {
        type: "h3",
        text: "2. Burn the roster.",
      },
      {
        type: "p",
        text: "The illusion of choice in NYC ruins relationships before they start. If you meet someone who actually texts back, makes plans, and respects your time, focus on them. Put the apps away and see it through.",
      },
      {
        type: "h3",
        text: "3. Change your geography.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "To find a partner before an arranged marriage, you need to treat your dating life with the same urgency your parents treat your biodata. Take control of your timeline by negotiating a set window with your family, while actively seeking out spaces filled with serious, commitment-minded South Asian singles.",
      },
      {
        type: "h3",
        text: "The Ticking Clock",
      },
      {
        type: "p",
        text: "We all know the feeling. You hit your late twenties, and suddenly the casual hints at family dinners turn into WhatsApp forwards of actual biodatas. The pressure is suffocating. You want to find love organically, but your parents are treating your singleness like a crisis that needs immediate project management.",
      },
      {
        type: "p",
        text: "You do not have to settle, but you do have to take control of the narrative.",
      },
      {
        type: "h3",
      ...
      {
        type: "h3",
        text: "2. Date like you are hiring a life co-founder.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "h3",
        text: "1. Reclaim your timeline.",
      },
      {
        type: "p",
        text: "There is absolutely zero shame in knowing you want to be married. Owning your timeline is the most powerful thing you can do for your dating life. It acts as an immediate repel for time-wasters.",
      },
      {
        type: "h3",
        text: "2. The Date 3 Rule.",
      },
      {
        type: "p",
