...
export const SPONSORSHIP_COPY = {
  ...
  heroSub:
    "Garam Masala Dating puts 250 people in a room every two weeks. South Asian professionals aged 22 to 40, high income, high social engagement, and zero ad fatigue. They're not scrolling past your brand. They're watching a live show where your product is part of the experience. 40+ shows produced. 10M+ social media views. This is the room brands want to be in.",
  demoBlurb:
    "Our audience is South Asian, desi diaspora, and culturally engaged non-South Asian guests. Primarily based in NYC metro, aged 22 to 40, with high disposable income and active social media presence. They're not passive attendees. They share the clips, quote the hosts, tag the brands, and come back every two weeks. 70%+ identify as South Asian. The remaining 30% are there because someone in their life dragged them to the show, and they come back on their own.",
...
export const MEDIA_KIT_STATS: MediaKitStat[] = [
  ...
  },
  {
    ...
    sub: "Aged 22 to 40, NYC metro, high disposable income. Tech, finance, consulting, medicine, law, and creative industries.",
  },
  {
    num: "40+",
...
export const TARGET_CATEGORIES: TargetCategory[] = [
  ...
  },
  {
    ...
    why: "High income, 22 to 40, urban professionals. This is the acquisition demo every financial brand targets, and they're all in one room.",
  },
];
...
export const SPONSORSHIP_FAQS: SponsorFaq[] = [
  {
    ...
    a: "Primarily South Asian professionals aged 22 to 40 in the NYC metro area. 70%+ identify as South Asian: Indian, Pakistani, Bangladeshi, Sri Lankan, and broader desi diaspora. High disposable income in tech, finance, consulting, medicine, law, and creative industries. Highly active on social media. Our audience shares clips, tags brands, and talks about the show online organically. The remaining 30% is non-South Asian guests who are there for the comedy, the dating culture, or because a friend dragged them. They come back on their own.",
  },
  {
    q: "Can I sponsor multiple shows?",
    a: "Yes, and it's the stronger play. Multi-show season packages are available at a per-show discount and give your brand recurring presence across an entire quarter or season rather than a single night. Repetition builds recognition, and our audience overlaps significantly show to show so they'll see your brand multiple times. Email our manager Caleb at caleb@garammasaladating.com and we'll put together a season proposal.",
  },
  {
