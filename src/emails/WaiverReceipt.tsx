...
import { formatWaiverForReading } from "@/lib/waiverDisplay";
...
const WaiverReceipt: FC<WaiverReceiptProps> = ({
  ...
  const readableWaiverText = formatWaiverForReading(waiverText);
    ...
    <Html lang="en">
      ...
      >
        ...
        >
          ...
          >
            Hi {firstName}, here&apos;s a copy of the waiver you signed. Keep
