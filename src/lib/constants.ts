...
export const VIDEO_METADATA = {
  ...
  title: "Garam Masala Dating — NYC's Live South Asian Comedy Dating Show",
  description:
    "Watch highlights from Garam Masala Dating, New York City's live South Asian dating show. Two real singles go on a blind date in front of 250 people. Hosted by comedians Surbhi and Wyatt.",
