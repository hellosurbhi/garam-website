...
export const VIDEO_METADATA = {
  ...
  title: "Garam Masala Dating: #1 Live Desi Comedy Dating Show",
  description:
    "Watch highlights from Garam Masala Dating, the #1 live desi dating show. Two real South Asian singles go on a blind date in front of 250 people. Hosted by comedians Surbhi and Wyatt.",
