...
export function buildOrganizationJsonLd(): string {
  return JSON.stringify({
    ...
    description:
      "Garam Masala Dating is America's #1 live desi comedy dating show and South Asian singles mixer, based in New York City. Real singles go on blind dates on stage in front of a 250-person live audience. Regular shows in Manhattan, monthly in Jersey City.",
